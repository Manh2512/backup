...
from ynet import device, apply_threshold, ImageDataset, YNet
import torch
...
generator = YNet(1, 1).to(device)

#load generator
checkpoint_G = torch.load(os.path.join(path_model,"checkpoint_YNet_final.pth"), map_location='cpu')
