...
from yNet_and_GAN import device, apply_threshold, ImageDataset, Generator
import torch
...
#load generator
checkpoint_G = torch.load(os.path.join(path_model,"checkpoint_YG.pth"), map_location='cpu')
