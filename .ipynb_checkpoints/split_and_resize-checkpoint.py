...
def split_and_resize(input_dir_1, input_dir_2, target_dir, output_dir, train_ratio=0.8, val_ratio=0.1):
...
#usage
input_folder_1 = 'Desktop/URECA/dataset_AI_students/Input1'
input_folder_2 = 'Desktop/URECA/dataset_AI_students/Input2'
target_folder = 'Desktop/URECA/dataset_AI_students/GT'
output_folder = 'Desktop/URECA/dataset_AI_students'
split_and_resize(input_folder_1, input_folder_2, target_folder, output_folder, train_ratio=0.8, val_ratio=0.1)
