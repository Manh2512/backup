...
def main():
    ...
    axs[2].plot(range(1, num_epochs + 1), test_loss_hist, marker='o', linestyle='-', color='r')
    axs[2].set_title('Validation and Test Loss vs. Epochs')
    axs[2].set_xlabel('Epochs')
    axs[2].set_ylabel('Generation Loss')
    axs[2].grid(True)

    plt.tight_layout()
    plt.savefig(plot_output+f'/YWGAN_ep={num_epochs}.png')
    plt.show()
